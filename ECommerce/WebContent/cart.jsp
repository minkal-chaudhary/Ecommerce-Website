...
<%@ page import="java.util.*,org.hibernate.Session,org.hibernate.*,org.hibernate.SessionFactory,org.hibernate.Transaction,org.hibernate.cfg.Configuration,com.minkal.*" %>
